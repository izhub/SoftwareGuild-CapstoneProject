...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        return{opera: n, webkit: r, ie: i, gecko: s, mac: l, iOS: c, android: u, contentEditable: d, transparentSrc: "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7", caretAfter: 8 != i, range: window.getSelection && "Range"in window, documentMode: i && !a ? document.documentMode || 7 : 10}
    }), r(d, [u], function (e) {
        function n(e) {
        ...
        return f.fn = f.prototype = {constructor: f, selector: "", context: null, length: 0, init: function (e, t) {
                ...
                if (a(e)) {
                    if (n.selector = e, r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : N.exec(e), !r)
                        return f(t).find(e);
                    if (r[1])
            ...
            return f.extend(t, this), t
                ...
                e.style.cssText = t
            }})), i.ie && i.ie < 9 && (B["float"] = "styleFloat", x(M, "set", {opacity: function (e, t) {
                var n = e.style;
        ...
        function t(n) {
            ...
            return q(H, {startContainer: L, startOffset: 0, endContainer: L, endOffset: 0, collapsed: F, commonAncestorContainer: L, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: u, selectNode: d, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: h, extractContents: m, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: M}), H
        }
                ...
                if (n = e._addCacheSuffix(n), a[n] ? y = a[n] : (y = {passed: [], failed: []}, a[n] = y), i && y.passed.push(i), l && y.failed.push(l), 1 != y.status) {
                    ...
                    if (y.status = 1, m = t.createElement("link"), m.rel = "stylesheet", m.type = "text/css", m.id = "u" + o++, m.async = !1, m.defer = !1, v = (new Date).getTime(), "onload"in m && !d())
                        ...
                        if (navigator.userAgent.indexOf("Firefox") > 0)
                            return g = t.createElement("style"), g.textContent = '@import "' + n + '"', h(), void r(g);
                        p()
                    }
                    r(m), m.href = n
                }
        ...
        return function (n) {
            ...
            "onselectionchange"in n.getDoc() || n.on("NodeChange Click MouseUp KeyUp Focus", function (t) {
                var r, o;
                r = n.selection.getRng(), o = {startContainer: r.startContainer, startOffset: r.startOffset, endContainer: r.endContainer, endOffset: r.endOffset}, "nodechange" != t.type && e.compareRanges(o, i) || n.fire("SelectionChange"), i = o
        ...
        function n(e) {
            ...
            return i[e] ? i[e] : (l = t("id accesskey class dir lang style tabindex title"), c = t("address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul"), u = t("a abbr b bdo br button cite code del dfn em embed i iframe img input ins kbd label map noscript object q s samp script select small span strong sub sup textarea u var #text #comment"), "html4" != e && (l.push.apply(l, t("contenteditable contextmenu draggable dropzone hidden spellcheck translate")), c.push.apply(c, t("article aside details dialog figure header footer hgroup section nav")), u.push.apply(u, t("audio canvas command datalist mark meter output progress time wbr video ruby bdi keygen"))), "html5-strict" != e && (l.push("xml:lang"), p = t("acronym applet basefont big font strike tt"), u.push.apply(u, p), s(p, function (e) {
                ...
                n(e, "", d)
                    ...
                    r("a", "download"), r("link script img", "crossorigin"), r("iframe", "sandbox seamless allowfullscreen")), s(t("a form meter progress dfn"), function (e) {
        ...
        return function (e) {
            ...
            var v = this, y = {}, b = {}, C = [], x, w, _, E, N, k, S, T, R, A, B, D, M, H = {}, L = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, p = [], h, m, g, v, y, b, C, x, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
                for (L = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), P = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), H = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), _ = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = L.exec(e); ) {
                    if (u < c.index && l.text(z(e.substr(u, c.index - u))), d = c[6])
                        ...
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && H[d] && p.length > 0 && p[p.length - 1].name === d && o(d), !_ || (E = a.getElementRule(d))) {
                            if (N = !0, _ && (T = E.attributes, R = E.attributePatterns), (S = c[8]) ? (y = -1 !== S.indexOf("data-mce-type"), y && b && (N = !1), h = [], h.map = {}, S.replace(P, s)) : (h = [], h.map = {}), _ && !y) {
                                if (A = E.attributesRequired, B = E.attributesDefault, D = E.attributesForced, M = E.removeEmptyAttrs, M && !h.length && (N = !1), D)
                                    for (m = D.length; m--; )
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, _, E, N, k, S, T, R, A = [], B, D, M, H, L, P, O, I;
        ...
        return function (r, i) {
            ...
            function l(e, t, r) {
                ...
                g(), l = C.getPos(e, U), A = l.x, B = l.y, p = e.getBoundingClientRect(), u = p.width || p.right - p.left, d = p.height || p.bottom - p.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? x(N, function (e, i) {
                    function o(t) {
                        T = t.screenX, R = t.screenY, D = w.clientWidth, M = w.clientHeight, H = M / D, k = e, e.startPos = {x: u * e[0] + A, y: d * e[1] + B}, $ = U.scrollWidth, q = U.scrollHeight, _ = w.cloneNode(!0), C.addClass(_, "mce-clonedresizable"), C.setAttrib(_, "data-mce-bogus", "all"), _.contentEditable = !1, _.unSelectabe = !0, C.setStyles(_, {left: A, top: B, margin: 0}), _.removeAttribute("data-mce-selected"), U.appendChild(_), C.bind(I, "mousemove", a), C.bind(I, "mouseup", s), F != I && (C.bind(F, "mousemove", a), C.bind(F, "mouseup", s)), E = C.add(U, "div", {"class": "mce-resize-helper", "data-mce-bogus": "all"}, D + " &times; " + M)
                    }
                    var l, c;
            ...
            function p(e) {
                ...
                L = !0, i.fire("ObjectResizeStart", {target: w, width: w.clientWidth, height: w.clientHeight}), i.getDoc().selection.empty(), l(t, r, S)
            }
            function h(e) {
                var t = e.srcElement;
                if (t != w) {
            ...
            var C = i.dom, x = t.each, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I = i.getDoc(), F = document, z = n.ie && n.ie < 11, W = Math.abs, V = Math.round, U = i.getBody(), $, q;
            ...
            }), i.on("remove", g), {isResizable: o, showResizeRect: l, hideResizeRect: c, updateResizeRect: u,
                controlSelect: y, destroy: b}
        }
        ...
        return function (a) {
            ...
            function d() {
                h({valigntop: [{selector: "td,th", styles: {verticalAlign: "top"}}], valignmiddle: [{selector: "td,th", styles: {verticalAlign: "middle"}}], valignbottom: [{selector: "td,th", styles: {verticalAlign: "bottom"}}], alignleft: [{selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: {textAlign: "left"}, defaultBlock: "div"}, {selector: "img,table", collapsed: !1, styles: {"float": "left"}}], aligncenter: [{selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: {textAlign: "center"}, defaultBlock: "div"}, {selector: "img", collapsed: !1, styles: {display: "block", marginLeft: "auto", marginRight: "auto"}}, {selector: "table", collapsed: !1, styles: {marginLeft: "auto", marginRight: "auto"}}], alignright: [{selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: {textAlign: "right"}, defaultBlock: "div"}, {selector: "img,table", collapsed: !1, styles: {"float": "right"}}], alignjustify: [{selector: "figure,p,h1,h2,h3,h4,h5,h6,td,th,tr,div,ul,ol,li", styles: {textAlign: "justify"}, defaultBlock: "div"}], bold: [{inline: "strong", remove: "all"}, {inline: "span", styles: {fontWeight: "bold"}}, {inline: "b", remove: "all"}], italic: [{inline: "em", remove: "all"}, {inline: "span", styles: {fontStyle: "italic"}}, {inline: "i", remove: "all"}], underline: [{inline: "span", styles: {textDecoration: "underline"}, exact: !0}, {inline: "u", remove: "all"}], strikethrough: [{inline: "span", styles: {textDecoration: "line-through"}, exact: !0}, {inline: "strike", remove: "all"}], forecolor: {inline: "span", styles: {color: "%value"}, links: !0, remove_similar: !0}, hilitecolor: {inline: "span", styles: {backgroundColor: "%value"}, links: !0, remove_similar: !0}, fontname: {inline: "span", styles: {fontFamily: "%value"}}, fontsize: {inline: "span", styles: {fontSize: "%value"}}, fontsize_class: {inline: "span", attributes: {"class": "%value"}}, blockquote: {block: "blockquote", wrapper: 1, remove: "all"}, subscript: {inline: "sub"}, superscript: {inline: "sup"}, code: {inline: "code"}, link: {inline: "a", selector: "a", remove: "all", split: !0, deep: !0, onmatch: function () {
                            return!0
                        }, onformat: function (e, t, n) {
                            se(n, function (t, n) {
                                $.setAttrib(e, n, t)
                            })
                        }}, removeformat: [{selector: "b,strong,em,i,font,u,strike,sub,sup,dfn,code,samp,kbd,var,cite,mark,q,del,ins", remove: "all", split: !0, expand: !1, block_expand: !0, deep: !0}, {selector: "span", attributes: ["style", "class"], remove: "empty", split: !0, expand: !1, deep: !0}, {selector: "*", attributes: ["style", "class"], split: !1, expand: !1, deep: !0}]}), se("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/), function (e) {
            ...
            function y(t, n, r) {
                ...
                var c = p(t), d = c[0], f, h, m = !r && q.isCollapsed();
                if (d)
                    if (r)
                        r.nodeType ? (h = $.createRng(), h.setStartBefore(r), h.setEndAfter(r), l(H(h, c), null, !0)) : l(r, null, !0);
                    else if (m && d.inline && !$.select("td.mce-item-selected,th.mce-item-selected").length)
                        W("apply", t, n);
                    else {
                        var g = a.selection.getNode();
                        G || !c[0].defaultBlock || $.getParent(g, $.isBlock) || y(c[0].defaultBlock), a.selection.setRng(o()), f = q.getBookmark(), l(H(q.getRng(ee), c), f), d.styles && (d.styles.color || d.styles.textDecoration) && (ce(g, v, "childNodes"), v(g)), q.moveToBookmark(f), V(q.getRng(ee)), a.nodeChanged()
                    }
            }
            function b(e, t, n, r) {
                function i(e) {
                ...
                function d(e) {
                    var t = $.get(e ? "_start" : "_end"), n = t[e ? "firstChild" : "lastChild"];
                ...
                function f(e) {
                    ...
                    if (e = H(e, h, ee), m.split) {
                        if (t = z(e, ee), n = z(e), t != n) {
                            if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t : t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && l(n) && n.firstChild && (n = n.firstChild || n), $.isChildOf(t, n) && !l(t) && !l(n))
                                return t = M(t, "span", {id: "_start", "data-mce-type": "bookmark"}), u(t), void(t = d(ee));
                            t = M(t, "span", {id: "_start", "data-mce-type": "bookmark"}), n = M(n, "span", {id: "_end", "data-mce-type": "bookmark"}), u(t), u(n), t = d(ee), n = d()
                        } else
                            t = n = u(t);
                    ...
                    j.walk(e, function (e) {
                        se(e, function (e) {
                            i(e), 1 === e.nodeType && "underline" === a.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === g(e.parentNode) && P({deep: !1, exact: !0, inline: "span", styles: {textDecoration: "underline"}}, null, e)
                        })
                    })
                }
                var h = p(e), m = h[0], v, y, b = !0;
                        ...
                        if (s.length === ne) {
                            for (o in s)
                                if (s.hasOwnProperty(o)) {
                                    if (a = "attributes" === i ? $.getAttrib(e, o) : R(e, o), r && !a && !t.exact)
                                        return;
                                    if ((!r || t.exact) && !T(a, A(B(s[o], n), o)))
                                        return
                                }
                        } else
            ...
            function H(t, n, r) {
                function i(e) {
                    ...
                    var r, i, o, a, s;
                    if (r = i = e ? g : y, a = e ? "previousSibling" : "nextSibling", s = $.getRoot(), 3 == r.nodeType && !D(r) && (e ? v > 0 : b < r.nodeValue.length))
                        return r;
                    for (; ; ) {
                ...
                function o(e, t) {
                    for (t === ne && (t = 3 === e.nodeType?e.length:e.childNodes.length); e && e.hasChildNodes(); )
                        e = e.childNodes[t], e && (t = 3 === e.nodeType ? e.length : e.childNodes.length);
                    return{node: e, offset: t}
                }
                function l(e) {
                    for (var t = e; t; ) {
                        if (1 === t.nodeType && re(t))
                            return"false" === re(t) ? t : e;
                        t = t.parentNode
                    }
                    return e
                }
                ...
                function d(e, r) {
                    ...
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = c(e), o = 0; o < i.length; o++)
                        for (a = 0; a < n.length; a++)
                            if (s = n[a], !("collapsed"in s && s.collapsed !== t.collapsed) && $.is(i[o], s.selector))
                                return i[o];
                    return e
                }
                function f(e, t) {
            ...
            function O(e, t) {
                ...
                t.block && (G ? r == $.getRoot() && (t.list_block && T(e, t.list_block) || se(le(e.childNodes), function (e) {
                    K(G, e.nodeName.toLowerCase()) ? i ? i.appendChild(e) : (i = M(e, G), $.setAttribs(i, a.settings.forced_root_block_attrs)) : i = 0
            ...
            function W(t, n, r, i) {
                function o(e) {
                    var t = $.create("span", {id: g, "data-mce-bogus": !0, style: v ? "color:red" : ""});
                ...
                function d(e, t) {
                    var n, r;
                    if (e)
                        r = q.getRng(!0), l(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), $.remove(e)) : (n = u(e), n.nodeValue.charAt(0) === J && (n.deleteData(0, 1), r.startContainer == n && r.startOffset > 0 && r.setStart(n, r.startOffset - 1), r.endContainer == n && r.endOffset > 0 && r.setEnd(n, r.endOffset - 1)), $.remove(e, 1)), q.setRng(r);
                ...
                function f() {
                    var e, t, i, a, s, l, d;
                    e = q.getRng(!0), a = e.startOffset, l = e.startContainer, d = l.nodeValue, t = c(q.getStart()), t && (i = u(t)), d && a > 0 && a < d.length && /\w/.test(d.charAt(a)) && /\w/.test(d.charAt(a - 1)) ? (s = q.getBookmark(), e.collapse(!0), e = H(e, p(n)), e = j.split(e), y(n, r, e), q.moveToBookmark(s)) : (t && i.nodeValue === J ? y(n, r, t) : (t = o(!0), i = t.firstChild, e.insertNode(t),
                            a = 1, y(n, r, t)), q.setCursorLocation(i, a))
                }
                function h() {
                    var e = q.getRng(!0), t, a, l, c, u, d, f = [], h, m;
                    ...
                    if (d)
                        if (c)
                            l = q.getBookmark(), e.collapse(!0), e = H(e, p(n), !0), e = j.split(e), b(n, r, e), q.moveToBookmark(l);
                        else {
            ...
            function V(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = X(n), n = n.parentNode, i = !0), 1 == n.nodeType)
                    for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, $.getParent(n, $.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())
                        if (3 == a.nodeType && !D(a))
                            return l = $.create("a", {"data-mce-bogus": "all"}, J), a.parentNode.insertBefore(l, a), t.setStart(a, 0), q.setRng(t), void $.remove(l)
            }
            var U = {}, $ = a.dom, q = a.selection, j = new t($), K = a.schema.isValidChild, Y = $.isBlock, G = a.settings.forced_root_block, X = $.nodeIndex, J = "\ufeff", Q = /^(src|href|style)$/, Z = !1, ee = !0, te, ne, re = $.getContentEditable, ie, oe, ae = n.isBookmarkNode, se = i.each, le = i.grep, ce = i.walk, ue = i.extend;
            ue(this, {get: p, register: h, unregister: m, apply: y, remove: b, toggle: C, match: w, matchAll: _, matchNode: x, canApply: E, formatChanged: N, getCssText: k}), d(), f(), a.on("BeforeGetContent", function (e) {
                oe && "raw" != e.format && oe()
        ...
        return o = new RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (e) {
            function n() {
                var t = e.getContent({format: "raw", no_events: 1}), n = /<(\w+) [^>]*data-mce-bogus="all"[^>]*>/g, a, s, l, c, u, d = e.schema;
            ...
            return e.on("init", function () {
                ...
                var i = r.keyCode;
                (i >= 33 && 36 >= i || i >= 37 && 40 >= i || 45 == i || 13 == i || r.ctrlKey) && (s(), e.nodeChanged()), (46 == i || 8 == i || t.mac && (91 == i || 93 == i)) && e.nodeChanged(), f && l.typing && (e.isDirty() || (a(u[0] && n() != u[0].content), e.isNotDirty || e.fire("change", {level: u[0], lastLevel: null})), e.fire("TypingUndo"), f = !1, e.nodeChanged())
                ...
                t.isDefaultPrevented() || e.nodeChanged()
                    ...
                    if (t = t || {}, t.content = n(), p || e.removed)
                        return null;
                    if (s = u[c], e.fire("BeforeAddUndo", {level: t, lastLevel: s, originalEvent: r}).isDefaultPrevented())
                        return null;
        ...
        return function (i) {
            function o(o) {
                ...
                function C(e, t) {
                    ...
                    if (r = a.getParent(e, a.isBlock), c = i.getBody().nodeName.toLowerCase(), !r || !p(r)) {
                        if (r = r || T, !r.hasChildNodes())
                            return n = a.create(d), v(n), r.appendChild(n), k.setStart(n, 0), k.setEnd(n, 0), n;
                ...
                function x() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (F = "LI"), H = F ? y(F) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, P) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(P)) : P.parentNode.insertBefore(H, P) : e() ? (a.insertAfter(H, t()), h(H)) : (P = t(), S = k.cloneRange(), S.setStartAfter(B), S.setEndAfter(P), L = S.extractContents(), "LI" == F && "LI" == L.firstChild.nodeName ? (H = L.firstChild, a.insertAfter(L, P)) : (a.insertAfter(L, P), a.insertAfter(H, P))), a.remove(B), g(H), c.add()
                }
                function w() {
                ...
                if (k = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(k), R = k.startContainer, A = k.startOffset, F = (l.force_p_newlines ? "p" : "") || l.forced_root_block, F = F ? F.toUpperCase() : "", D = a.doc.documentMode, M = o.shiftKey, 1 == R.nodeType && R.hasChildNodes() && (z = A > R.childNodes.length - 1, R = R.childNodes[Math.min(A, R.childNodes.length - 1)] || R, A = z && 3 == R.nodeType ? R.nodeValue.length : 0), T = E(R)) {
                        if (c.beforeChange(), !a.isBlock(T) && T != a.getRoot())
                            return void((!F || M) && w());
                        if ((F && !M || !F && M) && (R = C(R, A)), B = a.getParent(R, a.isBlock), P = B ? a.getParent(B.parentNode, a.isBlock) : null, O = B ? B.nodeName.toUpperCase() : "", I = P ? P.nodeName.toUpperCase() : "", "LI" != I || o.ctrlKey || (B = P, O = I), /^(LI|DT|DD)$/.test(O)) {
                            if (!F && M)
                                return void w();
                            if (a.isEmpty(B))
                                return void x()
                        ...
                        if ("PRE" == O && l.br_in_pre !== !1) {
                            if (!M)
                                return void w()
                        } else if (!F && !M && "LI" != O || F && M)
                            return void w();
                        F && B === i.getBody() || (F = F || "P", b() ? (H = /^(H[1-6]|PRE|FIGURE)$/.test(O) && "HGROUP" != I ? y(F) : y(), l.end_container_on_empty_block && p(P) && a.isEmpty(B) ? H = a.split(P, B) : a.insertAfter(H, B), g(H)) : b(!0) ? (H = B.parentNode.insertBefore(y(), B), h(H), g(B)) : (S = k.cloneRange(), S.setEndAfter(B), L = S.extractContents(), _(L), H = L.firstChild, a.insertAfter(L, B), m(H), N(B), g(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {newBlock: H}), c.add())
                    }
                }
            }
        ...
        return function (r) {
            function v(e, t, n, i) {
                var o, a, c = 0;
                if (/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) || i && i.skip_focus || r.focus(), i = l({}, i), i = r.fire("BeforeExecCommand", {command: e, ui: t, value: n}), i.isDefaultPrevented())
                    return!1;
                if (a = e.toLowerCase(), o = H.exec[a])
                    return o(a, t, n), r.fire("ExecCommand", {command: e, ui: t, value: n}), !0;
                if (s(r.plugins, function (i) {
                    return i.execCommand && i.execCommand(e, t, n) ? (r.fire("ExecCommand", {command: e, ui: t, value: n}), c = !0, !1) : void 0
                }), c)
                    return c;
            ...
            function y(e) {
                var t;
                if (!r._isHidden()) {
                    if (e = e.toLowerCase(), t = H.state[e])
                        return t(e);
                    try {
            ...
            function b(e) {
                var t;
                if (!r._isHidden()) {
                    if (e = e.toLowerCase(), t = H.value[e])
                        return t(e);
                    try {
            ...
            r.on("PreInit", function () {
                B = r.dom, D = r.selection, L = r.settings, M = r.formatter
            }), l(this, {execCommand: v, queryCommandState: y, queryCommandValue: b, queryCommandSupported: w, addCommands: C, addCommand: x, addQueryStateHandler: _, addQueryValueHandler: E, hasCustomCommand: N}), C({"mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    "string" != typeof o && (_ = o.merge, o = o.content), /^ | $/.test(o) && (o = a(o)), d = r.parser, f = new e({}, r.schema), w = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', v = {content: o, format: "html", selection: !0}, r.fire("BeforeSetContent", v), o = v.content, -1 == o.indexOf("{$caret}") && (o += "{$caret}"), o = o.replace(/\{\$caret\}/, w), b = D.getRng();
                    ...
                    if (S.invalid) {
                        for (D.setContent(w), h = D.getNode(), m = r.getBody(), 9 == h.nodeType?h = C = m:C = h; C !== m; )
                            h = C, C = C.parentNode;
                        ...
                        o = f.serialize(g), C = h.firstChild, x = h.lastChild, !C || C === x && "BR" === C.nodeName ? B.setHTML(h, o) : D.setContent(o);
        ...
        var t = e.extend({init: function (e) {
                e = {border: 1, padding: 20, layout: "flex", pack: "center", align: "center", containerCls: "panel", autoScroll: !0, buttons: {type: "button", text: "Ok", action: "ok"}, items: {type: "label", multiline: !0, maxWidth: 500, maxHeight: 200}}, this._super(e)
                    ...
                    return"string" == typeof e && (e = {
                        text: e}), e.callback = n, t.msgBox(e)
        ...
        return function (s) {
            ...
            function h() {
                ...
                function l(e) {
                    ...
                    if (!e.collapsed && (n = v.getParent(t.getNode(e.startContainer, e.startOffset), v.isBlock), r = v.getParent(t.getNode(e.endContainer, e.endOffset), v.isBlock), l = s.schema.getTextBlockElements(), n != r && l[n.nodeName] && l[r.nodeName] && "false" !== v.getContentEditable(n) && "false" !== v.getContentEditable(r)))
                        return e.deleteContents(), i = o(n, !1), a = o(r, !0), v.isEmpty(r) || Y(n).append(r.childNodes), Y(r).remove(), i ? 1 == i.nodeType ? "BR" == i.nodeName ? (e.setStartBefore(i), e.setEndBefore(i)) : (e.setStartAfter(i), e.setEndAfter(i)) : (e.setStart(i, i.data.length), e.setEnd(i, i.data.length)) : a && (1 == a.nodeType ? (e.setStartBefore(a), e.setEndBefore(a)) : (e.setStart(a, 0), e.setEnd(a, 0))), y.setRng(e), !0
                }
                function c(e, n) {
                    var r, a, l, c, u, d;
                    if (!e.collapsed)
                ...
                function m(e) {
                    ...
                    }), t.observe(s.getDoc(), {childList: !0, attributes: !0, subtree: !0, attributeFilter: ["style"]}), s.getDoc().execCommand(e ? "ForwardDelete" : "Delete", !1, null), n = s.selection.getRng(), r = n.startContainer.parentNode, a.each(t.takeRecords(), function (e) {
            ...
            function m() {
                ...
                s.on("keydown", function (e) {
                    var t = e.keyCode, r, i;
                    if (!u(e) && (t == X || t == G)) {
                        if (r = s.selection.isCollapsed(), i = s.getBody(), r && !J.isEmpty(i))
                            return;
            ...
            function U() {
                s.on("touchstart", function (e) {
                    ...
                    t = e.target, n = (new Date).getTime(), i = e.changedTouches, !i || i.length > 1 || (r = i[0], s.once("touchend", function (e) {
                        ...
                        (new Date).getTime() - n > 500 || Math.abs(r.clientX - i.clientX) > 5 || Math.abs(r.clientY - i.clientY) > 5 || (o = {target: t}, K("pageX pageY clientX clientY screenX screenY".split(" "), function (e) {
                            o[e] = i[e]
            ...
            var K = a.each, Y = s.$, G = e.BACKSPACE, X = e.DELETE, J = s.dom, Q = s.selection, Z = s.settings, ee = s.parser, te = s.serializer, ne = o.gecko, re = o.ie, ie = o.webkit, oe = "data:text/mce-internal,", ae = re ? "Text" : "URL";
            k(), m(), L(), ie && (h(), v(), C(), R(), $(), _(), q(), U(), o.iOS ? (O(), I(), V()) : g()), re && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), H()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), j()), ne && (y(), b(), x(), S(), T(), A(), P(), F(), _())
        }
    }), r(le, [$], function (e) {
        function t(t) {
    ...
    }), r(de, [y, f, C, w, _, R, T, H, O, I, F, z, W, V, b, l, ae, E, k, se, u, d, ce, ue], function (e, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, E) {
        function N(e, t, i) {
            var o = this, a, s;
        ...
        var k = e.DOM, S = r.ThemeManager, T = r.PluginManager, R = w.extend, A = w.each, B = w.explode, D = w.inArray, M = w.trim, H = w.resolve, L = g.Event, P = x.gecko, O = x.ie;
        return N.prototype = {render: function () {
                ...
                }), n.load({initial: !0, format: "html"}), n.startContent = n.getContent({format: "raw"}), n.initialized = !0, n.bindPendingEventDelegates(), n.fire("init"), n.focus(!0), n.nodeChanged({initial: !0}), n.execCallback("init_instance_callback", n), n.contentStyles.length > 0 && (m = "", A(n.contentStyles, function (e) {
                    m += e + "\r\n"
        ...
        return v = {$: t, majorVersion: "4", minorVersion: "1.10", releaseDate: "2015-05-05", editors: [], i18n: s, activeEditor: null, setup: function () {
        ...
        return e.extend({recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, h, m, g, v = [], y, b, C, x, w, _, E, N, k, S, T, R, A, B, D, M, H, L, P, O, I, F, z = Math.max, W = Math.min;
                for (r = e.items().filter(":visible"), i = e.layoutRect(), o = e._paddingBox, a = e.settings, f = e.isRtl()?a.direction || "row-reversed":a.direction, s = a.align, l = e.isRtl()?a.pack || "end":a.pack, c = a.spacing || 0, ("row-reversed" == f || "column-reverse" == f) && (r = r.set(r.toArray().reverse()), f = f.split("-")[0]), "column" == f?(k = "y", E = "h", N = "minH", S = "maxH", R = "innerH", T = "top", A = "deltaH", B = "contentH", P = "left", H = "w", D = "x", M = "innerW", L = "minW", O = "right", I = "deltaW", F = "contentW"):(k = "x", E = "w", N = "minW", S = "maxW", R = "innerW", T = "left", A = "deltaW", B = "contentW", P = "top", H = "h", D = "y", M = "innerH", L = "minH", O = "bottom", I = "deltaH", F = "contentH"), d = i[R] - o[T] - o[T], _ = u = 0, t = 0, n = r.length; n > t; t++)
                    p = r[t], h = p.layoutRect(), m = p.settings, g = m.flex, d -= n - 1 > t ? c : 0, g > 0 && (u += g, h[S] && v.push(p), h.flex = g), d -= h[N], y = o[P] + h[L] + o[O], y > _ && (_ = y);
                if (x = {}, 0 > d ? x[N] = i[N] - d + i[A] : x[N] = i[R] - d + i[A], x[L] = _ + i[I], x[B] = i[R] - d, x[F] = _, x.minW = W(x.minW, i.maxW), x.minH = W(x.minH, i.maxH), x.minW = z(x.minW, i.startMinWidth), x.minH = z(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    ...
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[D] = o[P], t = 0, n = r.length; n > t; t++)
                        p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[N], "center" === s ? x[D] = Math.round(i[M] / 2 - h[H] / 2) : "stretch" === s ? (x[H] = z(h[L] || 0, i[M] - o[P] - o[O]), x[D] = o[P]) : "end" === s && (x[D] = i[M] - h[H] - o.top), h.flex > 0 && (y += h.flex * C), x[E] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
    ...
    }), a([l, c, u, d, f, p, h, m, g, y, b, C, x, _, E, N, k, S, T, R, A, B, D, M, H, L, O, I, F, z, W, V, U, $, q, j, K, Y, G, X, J, Q, Z, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, pe, he, me, ge, ve, ye, be, Ce, xe, we, _e, Ee, Ne, ke, Se, Te, Re, Ae, Be, De, Me, He, Le, Pe, Oe, Ie, Fe, ze, We, Ve, Ue, $e, qe, je, Ke, Ye, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st])
}(this);